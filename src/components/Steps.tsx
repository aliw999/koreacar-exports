  ...
  const steps = [
    {
      ...
      tooltip: "Быстрая регистрация за 2 минуты. Подтвердите email и начинайте работу с корейскими автомобилями.",
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <div className="text-center mb-16">
          ...
          <p className="text-xl text-muted-foreground max-w-3xl mx-auto">
            Путь к международным продажам корейских автомобилей 
                ...
                <div key={step.id} className="relative">
                  <Tooltip>
                    <TooltipTrigger asChild>
                      <Card 
                        className="group cursor-pointer transition-all duration-300 hover:shadow-large hover:-translate-y-2 bg-card border-border/50 hover:border-primary/30"
                  ...
                  {index < steps.length - 1 && (
                    <div className="hidden lg:block absolute top-1/2 -right-4 transform -translate-y-1/2 z-20">
                      <div className={`w-8 h-8 rounded-full bg-background border-2 border-primary/30 flex items-center justify-center transition-all duration-300 ${
