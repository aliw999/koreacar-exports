...
const Footer = () => {
  const footerLinks = {
    ...
    services: [
      { name: 'Для дилеров', href: '#' },
      { name: 'Для экспортеров', href: '#' },
      { name: 'Логистика', href: '#' },
      { name: 'Финансы', href: '#' },
    ],
    support: [
    ...
    legal: [
      ...
      { name: 'Соглашение об обработке данных', href: '#' },
      { name: 'Правила платформы', href: '#' },
    ],
  };
  ...
  return (
    <footer className="bg-foreground text-background">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <div className="border-t border-background/20 py-12">
          <div className="grid md:grid-cols-2 gap-8 items-center">
            <div>
              ...
              <p className="text-background/70">
                Получайте последние обновления продукта и рыночную аналитику
              </p>
            </div>
            <div className="flex gap-4">
              ...
              />
              <Button className="bg-hero-gradient hover:shadow-glow px-6">
                Подписаться
              </Button>
            </div>
          </div>
