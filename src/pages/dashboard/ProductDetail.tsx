...
import { Car, ArrowLeft, Edit, Save, Upload, Eye, MessageSquare, Calendar, DollarSign, Settings, Camera, FileText, TrendingUp } from 'lucide-react';
...
const ProductDetail = () => {
  ...
  const product = {
    ...
    features: ['Кожаный салон', 'Панорамная крыша', 'Система безопасности', 'Навигационная система', 'Камера заднего вида', 'Парковочные датчики'],
    specifications: {
      engine: '2.5L Turbo',
            ...
            <CardContent>
              {isEditing ? <div className="space-y-4">
                  <div>
                    ...
                    <Textarea id="description" defaultValue={product.description} rows={6} placeholder="Подробное описание автомобиля..." />
                  </div>
          ...
          <Card className="bg-card-gradient border-border/50">
            ...
            <CardContent>
              <div className="grid grid-cols-2 gap-2">
                {product.features.map((feature, index) => <div key={index} className="flex items-center gap-2 p-2 rounded-lg bg-muted/30">
            ...
            <CardContent className="space-y-4">
              {isEditing ? <div className="space-y-4">
                  <div>
                    ...
                    <Input id="price" type="number" defaultValue={product.price} placeholder="Укажите цену" />
                  </div>
